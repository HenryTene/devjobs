<form class="md:w-1/2 space-y-5" wire:submit.prevent='editarVacante'>
    ...
    <div>
        ...
        <textarea id="descripcion" wire:model="descripcion"
            class="rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 w-full" rows="5"
            placeholder="Descripción del trabajo">{{ old('descripcion') }}</textarea>
    ...
    <div>
        ...
        <div class="my-5 w-80">
            @if ($imagen_nueva)
            Imagen nueva:
            <img src="{{ $imagen_nueva->temporaryUrl() }}" alt="Imagen previa" class="mt-2 w-48 h-48 object-cover">
            @endif
